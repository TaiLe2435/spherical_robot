...
# App Main
#############
read_characteristic = "00001142-0000-1000-8000-00805f9b34fb"
write_characteristic = "00001143-0000-1000-8000-00805f9b34fb"
...
if __name__ == "__main__":
    ...
    try:
        asyncio.ensure_future(connection.manager()) # ensure_future is like thread
        asyncio.ensure_future(user_console_manager(connection))
        asyncio.ensure_future(main())
        loop.run_forever() # makes threads run
